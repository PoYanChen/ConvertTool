...
export const UUID_3D_TO_2D: Map<string, string> = new Map<string, string>();
...
export function initDiff() {
    ...
    UUID_2D_TO_3D.forEach((k, v) => {
        UUID_3D_TO_2D.set(v, k);
    });

    UUID_3D_TO_2D.set('fda095cb-831d-4601-ad94-846013963de8', 'eca5d2f2-8ef6-41c2-bbe6-f9c79d09c432');
